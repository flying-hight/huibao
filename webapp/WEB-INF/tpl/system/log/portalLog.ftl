...
<head>
	...
	<title>日志管理</title>
	<link rel="stylesheet" type="text/css" href="${base}/resources/style/base.css">
	<link rel="stylesheet" type="text/css" href="${base}/resources/themes/default/easyui.css">
	<link rel="stylesheet" type="text/css" href="${base}/resources/style/style.css">
	<!-- <link rel="stylesheet" type="text/css" href="${base}/resources/css/plugins.css"> -->
  ...
  <div class="ui-main-container">
	...
	<div class="ui-list-content">
			...
			<form name="searchform" method="get" action="" id ="searchform" class="ui-search-form">
				<ul class="search-list fn-clear">
					<li>
						...
						<span class="textbox"><input class="textbox-text textbox-prompt intOnly" type="text" maxlength=11 name="mobile" value=""/></span>
					</li>
					<li>
						<span class="name">电子邮箱：</span>
						<span class="textbox"><input class="textbox-text textbox-prompt" type="text" maxlength=120 name="email" value=""/></span>
					</li>
					<li>
						<span class="name">描述：</span>
						<span class="textbox"><input class="textbox-text textbox-prompt" type="text" maxlength=120 name="describe" value=""/></span>
					</li>
					<li class="btn-group">
		...
		${fButton(list, 'EXPORTEXCEL','<a href="javascript:doExcel(\'@URL@\');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>')}
			<!-- <a href="javascript:doExcel('/system/log/portalLogExcel');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a> -->
			<table id="portalLogList" class="easyui-tab" width="100%">
			</table>
...
<script type="text/javascript" src="${base}/resources/js/jquery.datagrid.js"></script>
...
//用户类别管理
	$("#portalLogList").datagrid({
		url:'/system/log/portal',
		method:'post',
		fitColumns:true,
		rownumbers:true,
		...
		pagePosition:top,
		columns:[[
			{field:'createTimeString',align:'center',width:"19%",title:'登录时间'},
			{field:'mobile',align:'center',width:"20%",title:'手机号码'},
			{field:'email',align:'center',width:"20%",title:'电子邮箱'},
			{field:'ip',align:'center',width:"20%",title:'IP'},
			{field:'describe',align:'center',width:"20%",title:'描述'}
		]],
	...
	$("#portalLogList").datagrid("getPager").pagination({
	    pageSize:20,
	    displayMsg:"",
