    ...
    <div class="ui-crumbs" id="crumbs">
		...
		<div class="ui-datagrid-wrap">
			...
			<div class="list-item fn-clear">
				<a href="${base}/operate/findUpProduct" class="dash-add-btn"><i class="ui-icon ui-icon-add"></i>新增上架产品</a>
			...
			columns:[[
				{field:'productId',align:'center',width:"10%",title:'产品ID',
		          	 formatter:function(value,rec){
						...
						return '<a class="operation-link" href="'+url+'?pId='+rec.productId+'&domainsts='+rec.domainStatus+'&domainid='+rec.domain_id+'">'+rec.productId+'</a>';
					  }},
