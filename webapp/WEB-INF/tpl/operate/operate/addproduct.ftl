         	...
         	<li class="ui-info-item ui-info-item-grey">
         		<label class="ui-info-lbl">产品ID</label>
         		  ...
         		  <input   name="domainProductsMap['${item.productId}'].productId" type="hidden" value="${item.productId}">
         		   <input   name="domainProductsMap['${item.productId}'].domainId" type="hidden" value="${domainid}">
        ...
        <ul class="ui-info-list">
          ...
          <input   type="text" id="countall${item.productId}"  readonly="true"  value="${item.domainQuantity}" class="easyui-validatebox ui-info-input"> 份
         	...
         	<li class="ui-info-item ui-info-item-grey ui-month-base">
         		...
         		<input id="startime${item_index+1}" name="domainProductsMap['${item.productId}'].effTimestr"    class="easyui-datetimebox ui-info-input date-timestart" data-options="editable:false"  >
         		<span class="showMessage"></span>
         	</li>
         	 <li class="ui-info-item ui-info-item-grey ui-month-base">
         		<label class="ui-info-lbl">下架时间</label>
         		<input id="endtime${item_index+1}" name="domainProductsMap['${item.productId}'].expTimestr"   class="easyui-datetimebox ui-info-input date-timeend" data-options="editable:false"  validType="mdMs['#startime${item_index+1}']">
         		<span class="showMessage"></span>
         	</li>
