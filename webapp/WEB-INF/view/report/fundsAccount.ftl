...
<head>
	...
	<title>统计报表-资金数据类-资金账户平衡报表</title>
...
<body style="overflow-x:hidden;">
  <div class="ui-main-container">
	...
	${fButton(list, 'EXPORTEXCEL','<a href="javascript:doExcel(\'@URL@\');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>')} 
		<#--<a href="javascript:doExcel('/report/fundsData/fundsAccountExcel');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>-->
		<div class="tab-box">
	...
	$(function(){
	$("#userList").datagrid({
		url:'/report/fundsData/fundsAccountList',
		method:'get',
		fitColumns:true,
		rownumbers:true,
		...
		columns:[[
			...
			{field:'termEndAmountBalanceYuan',align:'center',width:"8%",title:'期末账户余额(元)'},
			{field:'termBeginAmountBalanceYuan',align:'center',width:"10%",title:'期初账户余额(元)'},
			{field:'rechargeSumYuan',align:'center',width:"10%",title:'充值金额(元)'},
			{field:'withdrawSumYuan',align:'center',width:"11%",title:'提现金额(元)'},
			{field:'paymentSumYuan',align:'center',width:"12%",title:'消费支付金额(元)'},
			{field:'refundSumYuan',align:'center',width:"12%",title:'退款金额(元)'},
			{field:'differenceSumYuan',align:'center',width:"12%",title:'差额(元)'}
		]],
			...
			if(dataLen!=0){
			     ...
			     if(amount!=null){
			      tabhtml='<tr style="height: 40px;"><td><div class="datagrid-cell">'
						     ...
						     +notundef(amount.totalNine)+'</div></td></tr>';
