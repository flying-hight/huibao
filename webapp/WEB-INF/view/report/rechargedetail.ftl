...
<body>
  <div class="ui-main-container">
			...
			<ul class="search-list fn-clear">
				...
				<li>
					...
					<select class="seaway-combobox" name="state" >
						...
						<#if orderRechargeState?has_content>
							<#list orderRechargeState as cl>
	...
	${fButton(list, 'EXPORTEXCEL','<a href="javascript:doExcel(\'@URL@\');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>')} 
		<#--<a href="javascript:doExcel('/report/transactionMess/rechargeDetailExcel');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>-->
		<table id="rechargeList" class="easyui-tab" width="100%">
		</table>
	...
	$("#rechargeList").datagrid({
		url:'/report/transactionMess/selectRechargeDetail',
		method:'get',
		fitColumns:true,
		rownumbers:true,
		...
		pagePosition:top,
		columns:[[
			{field:'orderNo',align:'center',width:"15%",title:'交易流水号'},
			{field:'createTimeString',align:'center',width:"16%",title:'交易时间'},
			{field:'username',align:'center',width:"15%",title:'用户'},
			{field:'institutionChannel',align:'center',width:"14%",title:'银行通道'},
			{field:'institutionName',align:'center',width:"13%",title:'银行'},
			{field:'rechargeSumStr',align:'center',width:"13%",title:'充值金额(元)'},
