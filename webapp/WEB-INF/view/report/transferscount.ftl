...
<body>
  <div class="ui-main-container">
	...
	${fButton(list, 'EXPORTEXCEL','<a href="javascript:doExcel(\'@URL@\');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>')} 
		<#--<a href="javascript:doExcel('/report/transactionMess/transfersCountExcel');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>-->
		<table id="userList" class="easyui-tab" width="100%">
		</table>
		<#--<div class="amount-tab fn-clear" width="99.15%">
		    <ul width="100%">
		        <li style="width:39px;">总计</li>
			    <li style="width:9.6%;"></li>
			    <li style="width:14.55%;"></li>
			    <li style="width:14.55%;"></li>
			    <li style="width:14.55%;"></li>
			    <li style="width:14.55%;"></li>
			    <li style="width:13.55%;"></li>
			    <li style="width:13.75%;"></li>
		    </ul>
		</div>-->
	...
	$(function(){
		$("#userList").datagrid({
			url:'/report/transactionMess/selectTransfersCount',
			method:'get',
			fitColumns:true,
			rownumbers:true,
			...
			pagePosition:top,
			columns:[[
				{field:'countDayString',align:'center',width:"10%",title:'日期',
					  formatter:function(val,rec){
					       return dateformat(rec.countDayString)
					       }
				      },
				{field:'noSellerTransferNum',align:'center',width:"15%",title:'非商户用户转账笔数'},
				{field:'noSellerTransferSumYuan',align:'center',width:"15%",title:'非商户用户转账金额(元)'},
				{field:'sellerTransferNum',align:'center',width:"15%",title:'商户用户转账笔数'},
				{field:'sellerTransferSumYuan',align:'center',width:"15%",title:'商户用户转账金额(元)'},
				{field:'transferNum',align:'center',width:"14%",title:'转账笔数合计'},
				{field:'transferSumYuan',align:'center',width:"15%",title:'转账金额合计(元)'}
			]],
			...
			if(dataLen!=0){
			     ...
			     if(amount!=null){
			      tabhtml='<tr style="height: 40px;"><td><div class="datagrid-cell">'
						     ...
						     +notundef(amount.totalSeven)+'</div></td></tr>';
