...
<body>
  <div class="ui-main-container">
	...
	${fButton(list, 'EXPORTEXCEL','<a href="javascript:doExcel(\'@URL@\');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>')} 
		<#--<a href="javascript:doExcel('/report/transactionMess/paymentCountExcel');" class="ui-excel ui-add-pos">[导出EXCEL表格] </a>-->
		...
		<#--<div class="amount-tab fn-clear" width="99.15%">
		    <ul width="100%">
			    ...
			    <li style="width:17.4%;"></li>
			    <li style="width:17.5%;"></li>
			    <li style="width:17.6%;"></li>
			    <li style="width:17.5%;"></li>
			    <li style="width:15.55%;"></li>
		    </ul>
		</div>-->
	...
	$(function(){
	$("#userList").datagrid({
		url:'/report/transactionMess/paymentCount',
		method:'get',
		fitColumns:true,
		rownumbers:true,
		...
		columns:[[
			...
			{field:'paymentNum',align:'center',width:"18%",title:'支付交易笔数'},
			{field:'paymentSumYuan',align:'center',width:"18%",title:'支付交易金额(元)'},
			{field:'paymentRefundNum',align:'center',width:"18%",title:'退款交易笔数'},
			{field:'paymentRefundSumYuan',align:'center',width:"18%",title:'退款交易金额(元)'},
			{field:'paymentNetAmountYuan',align:'center',width:"17%",title:'支付交易净额(元)'}
		]],
