...
<div class="ui-main-container">
	...
	<div  class="ui-info-container">
		<div class="ui-info-content">
	      <form id="addMerchType" method="post" action="/content/article/add" >
	      	<input  name="cataId" value="${content?if_exists.cataId?if_exists}" type="hidden"/>
	      	<input  name="title" value="${content?if_exists.title?if_exists}" type="hidden"/>
	      	<input  name="parentId" value="${content?if_exists.parentId?if_exists}" type="hidden"/>
	      	<input  name="sorts" value="${content?if_exists.sorts?if_exists}" type="hidden"/>
...
<!--审核成功-->
  <div id="dlg" class="ui-dialog ">
    <div class="ui-dlg-content ui-relative">
     ...
     <div class="ui-dlg-text">文章新增成功</div>
...
<!--审核失败-->  
	<div id="dlgNo" class="ui-dialog">
		<div class="ui-dlg-content ui-relative">
		     ...
		     <div class="ui-dlg-text">文章新增失败</div>
		     <div class="ui-dlg-text2">返回
		       <a data-fn="backToList" href="/content/article/listView?type=s">文章管理</a>
		     </div>
		</div>
