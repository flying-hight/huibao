			...
			<form name="searchform" method="get" action="" id ="searchform" class="ui-search-form">
				...
				<li>
					<!-- <span class="name">用户类型：</span>
							<select class="ui-dselect" name="userType" >
					...
					<li id="Messages1" >
					 <span class="name">渠道：</span>
						<select name="domainCode" class="ui-dselect" id="domainCode">
				...
				<li>
					...
					<li>
						...
						<span class="textbox"><input class="textbox-text textbox-prompt textbox2" maxlength=120 type="text" name="userId" value=""/></span>
					</li>
					<li>
						<span class="name">用户名称：</span>
						<span class="textbox"><input class="textbox-text textbox-prompt textbox2" maxlength=120 type="text" name="username" value=""/></span>
					</li>
					<li class="btn-group">
	...
	$("#paramList").datagrid({
	   url:'/user/findList',
		...
		columns:[[
			...
			{field:'username',align:'center',width:"13%",title:'姓名'}, 
			{field:'userType',align:'center',width:"13%",title:'用户类型' ,
		 ...
		 {field:'idno',align:'center',width:"13%",title:'证件号码'}, 
		 {field:'mobile',align:'center',width:"13%",title:'手机'}, 
		 {field:'email',align:'center',width:"13%",title:'邮箱'}, 
			{field:'createTime',align:'center',width:"13%",title:'注册时间',formatter:function(value,rec){
				return getDate(rec.createTime);
			 }},
			 {field:'domainName',align:'center',width:"13%",title:'渠道'}
