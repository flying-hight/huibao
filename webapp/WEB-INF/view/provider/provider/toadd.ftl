			          ...
			          <tbody>
				          <tr class="platform-part">
				            ...
				            <td>
				                	...
				                	<option value="1" <#if providerAccount.acctType == 1>selected</#if>>信用额度</option>
				                	<option value="2" <#if providerAccount.acctType == 2>selected</#if>>预付款</option>
				                </select>
				            </td>
				          </tr>
