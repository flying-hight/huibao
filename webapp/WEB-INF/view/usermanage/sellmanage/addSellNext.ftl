...
<div class="ui-main-container">
  ...
  <form id ="addMerchTypeNext" method="post" action="/userManage/sellerManage/addSellerOk" >
		<div class="ui-info-wrap ui-dotted">
          ...
          <tbody>
	          ...
	          <input type="hidden"  name="sellerLevel" value="${usersSellerExtendMdl.sellerLevel}" />
			    </tbody>
	      </table>
			</div>
		</div>
      ...
      <a href="javascript:ajaxSubmit('addMerchTypeNext','dlgOk2','dlgWarn');" class="ui-red-btn ui-pos3">提 交</a>
    </div>
	</form>
	</div>
</div>
  <!--成功提示-->	      
	<div id="dlgOk2" class="ui-dialog ok2-dialog">
	    ...
	    <div class="ui-dlg-text">新增商户已提交,等待审核.</div>
