...
<div id="dlgList" class="ui-dialog list-dialog" style="display:block;">
		...
		<form  id="searchform2" class="ui-search-form">
			...
			<ul class="search-list fn-clear">
			    <li>
					...
					<span class="textbox">
					  <input class="textbox-text textbox-prompt" type="text" name="realName" />
					</span>
				</li>
				<li>
					<span class="name">用户类型：</span>
					<select class="seaway-combobox" name="userType" >
	...
	<div class="list-item dlg-list-item fn-clear ui-relative">
	    <form id="typeOtherAdd" action="/userManage/userTypeManage/addUser" method="post">
			...
			<a href="javascript:addTypeUser('typeOtherAdd');" id="batchAdd" class="ui-trans-btn ui-batch-pos">批量添加</a>
		</form>
	</div>
	<!-- 列表end -->
	</div>
	...
	<div id="dlgConfirm2" class="ui-dialog warn-dialog confirm-dialog">
	    ...
	    <div class="ui-dlg-text">确认要将这些用户加入"<span id="del-tip2" class="del-tip"></span>"类别吗？</div>
	...
	<div id="dlgConfirm3" class="ui-dialog warn-dialog confirm-dialog">
		<div class="ui-dlg-content ui-relative">
	    <div class="ui-dlg-text"><span id="del-tip"></span></div>
	...
	$(function(){
		//列表
		$("#dgck-list").datagrid({
			url:'/userManage/userTypeManage/selectUserTypeUserList?levelId=1',
			method:'get',
			fitColumns:true,
			rownumbers:true,
			...
			columns:[[
				...
				{field:'userTypeName',align:'center',width:"12%",title:'用户类型'},
				{field:'statusName',align:'center',width:"12%",title:'用户状态'},
