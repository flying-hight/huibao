...
<body>
  <div class="ui-main-container">
	...
	<input type="hidden" id="reviewPhase" value="${reviewPhase}"/>
	...
	<div class="list-item fn-clear ui-relative"> 
	    ...
	    <#--<a href="javascript:doExcel('/userManage/retrievePwd/retrieveListExcel/${reviewPhase}');" class="ui-excel ui-add-pos">[导出EXCEL表格]</a>-->
	...
	$(function(){
	$("#userList").datagrid({
		url:'/userManage/retrievePwd/selectRetrieveList',
		method:'get',
		fitColumns:true,
		rownumbers:true,
		...
		pagePosition:top,
		columns:[[
			{field:'userId',align:'center',width:"16%",title:'用户ID',sortable:true,
				formatter:function(value,rec){
				   return pad(rec.userId, 6);
				}
			},
			{field:'username',align:'center',width:"19%",title:'账户名'},
			{field:'realName',align:'center',width:"17%",title:'实名'},
			{field:'operTypeName',align:'center',width:"17%",title:'找回种类'},
			...
			{field:'opt',align:'center',width:"15%",title:'操作',
				formatter:function(value,rec){
				  ...
				  if((${reviewPhase}==0&&rec.auditState==10)||(${reviewPhase}==1&&rec.auditState==20)){
				    ...
				    //html='<a class="operation-link" href="/userManage/retrievePwd/selectRetrievePwdView/${reviewPhase}?id='+rec.id+'">[审核]</a>';
				  }
			        return  html;
				}
			}
