					...
					<table class="ui-center-tab">
			          <tbody>
				          <tr class="platform-part">
				            ...
				            <input type="hidden" name="domainKeyMap['${item?if_exists.keyId}'].keyId" value="${item?if_exists.keyId}" >
				            </td>
				          </tr>
				            <tr class="platform-part">
				            <td class="ui-oddtd">有效期：</td>
				            <td colspan="3">
				            	   <input id="effTime" name="domainKeyMap['${item?if_exists.keyId}'].effTimeStr" class="easyui-datebox" value="${item.effTime?string('yyyy-MM-dd')}" validType="mdM['#effTime']">
					<em>至</em>
					<input id="expTime" name="domainKeyMap['${item?if_exists.keyId}'].expTimeStr" class="easyui-datebox" value="${item.expTime?string('yyyy-MM-dd')}" validType="mdM['#expTime']">
				            </td>
				          </tr> 
				          <tr class="platform-part">
				           ...
				           <td colspan="3">
				            ...
				            <#if item.keySts == -10>失效</#if>
				             ...
				             <input id='keySts' 　  type="hidden" maxlength=40  class=" ui-dinput" name="domainKeyMap['${item?if_exists.keyId}'].keySts" value="${item?if_exists.keySts}"/>
				            </td>
				          </tr>
				            <tr class="platform-part">
				            <td class="ui-oddtd">密钥：</td>
				            <td>
				            	 <input id='publicKey' 　  type="text" maxlength=40  class=" ui-dinput" name="domainKeyMap['${item?if_exists.keyId}'].publicKey" value="${item?if_exists.publicKey}"/>
				            </td>
				            </tr>
						  </tbody>
		      		</table>
