...
//用户类别管理
	$("#paramList").datagrid({
	   url:'/domain/findkeyList',
		...
		pagePosition:top,
		columns:[[
			{field:'dId',align:'center',width:"20%",title:'渠道ID',styler:function(value,rowData,rowIndex){
 		var html='cursor:pointer;color:blue';
 		return html;
			} },
			{field:'domainName',align:'center',width:"20%",title:'渠道名称'}, 
			...
			{field:'domainIdTemp',align:'center',width:"20%",title:'配置状态' ,
			formatter:function(value,rec){
				var s = '已设置';
				if(rec.domainIdTemp ==0){
					s = '未设置';
				} 
		        return s;
			 }},
...
if(field=='dId'){
window.location.href="/domain/tokeyInfo?domainId="+value;
